...
const deckImages = [
  "/future-work-life/slide-visual-1.png",
  "/future-work-life/slide-visual-2.png",
  "/future-work-life/slide-visual-3.png"
]

export default function MethodPage() {
  return (
    <main className="container section">
      <a className="ghost-btn icon-nav no-print" href="/" aria-label="Back to home" title="Back to home">Home</a>
      ...
      <section className="method-deck-hero">
        <div>
          <span className="kicker">Future work life</span>
          <h3>Human + AI Sadhana money-energy path</h3>
          <p>The attached deck gives users a simple view of how human discipline, AI partnership, livelihood energy and inner correction may shape future work life.</p>
          <a className="primary-btn" href="/future-work-life-deck.pptx" target="_blank" rel="noreferrer">Open future work-life deck</a>
        </div>
        <img src="/future-work-life/slide-visual-1.png" alt="Future work-life concept from the Sadhana deck" />
      </section>
      ...
      <section className="deck-preview-grid">
        {deckImages.map((src, index) => (
          <figure className="deck-preview" key={src}>
            <img src={src} alt={`Future work-life slide visual ${index + 1}`} />
          </figure>
        ))}
      </section>
